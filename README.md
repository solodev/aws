...
<table>
	<tr>
		...
		<td><strong><span style="font-size: 1.8rem; border-bottom: 1px solid #ececec;">Solodev Lite</span></strong><br />Solodev CMS, PHP, Apache, MySQL, and Mongo on a single web server</td>
